...
function c87210505.cost(e,tp,eg,ep,ev,re,r,rp,chk)
	...
	if chk==0 then return ft>-1 and Duel.CheckReleaseGroup(tp,c87210505.costfilter,1,nil,ft,tp) end
	local g=Duel.SelectReleaseGroup(tp,c87210505.costfilter,1,1,nil,ft,tp)
