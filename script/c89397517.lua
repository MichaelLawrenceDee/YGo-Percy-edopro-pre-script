...
function c89397517.cost(e,tp,eg,ep,ev,re,r,rp,chk)
	...
	if chk==0 then return ft>-1 and Duel.CheckLPCost(tp,2000) and Duel.CheckReleaseGroup(tp,c89397517.cfilter,1,nil,ft,tp) end
	Duel.PayLPCost(tp,2000)
	local sg=Duel.SelectReleaseGroup(tp,c89397517.cfilter,1,1,nil,ft,tp)
