...
function c56524813.spcost(e,tp,eg,ep,ev,re,r,rp,chk)
	...
	if chk==0 then return ft>-1 and Duel.CheckReleaseGroup(tp,c56524813.cfilter,1,e:GetHandler(),ft,tp) end
	local g=Duel.SelectReleaseGroup(tp,c56524813.cfilter,1,1,e:GetHandler(),ft,tp)
