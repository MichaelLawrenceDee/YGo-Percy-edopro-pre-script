...
function c21140872.initial_effect(c)
	--fusion material
	c:EnableReviveLimit()
	aux.AddFusionProcMix(c,true,true,74677422,aux.FilterBoolFunctionEx(Card.IsRace,RACE_WARRIOR))
	--equip
	...
	c:RegisterEffect(e1)
	aux.AddEREquipLimit(c,nil,c21140872.eqval,c21140872.equipop,e1)
	--negate
...
function c21140872.eqval(ec,c,tp)
...
function c21140872.equipop(c,e,tp,tc)
