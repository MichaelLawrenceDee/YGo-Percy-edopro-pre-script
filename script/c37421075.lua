...
function c37421075.cost(e,tp,eg,ep,ev,re,r,rp,chk)
	...
	if chk==0 then return ft>0 and Duel.CheckReleaseGroup(tp,c37421075.cfilter,1,nil,ft,tp) end
	local rg=Duel.SelectReleaseGroup(tp,c37421075.cfilter,1,1,nil,ft,tp)
