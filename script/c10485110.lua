...
function c10485110.cfilter(c,ft,tp)
...
function c10485110.spcon(e,c)
	...
	return ft>-1 and Duel.CheckReleaseGroup(tp,c10485110.cfilter,1,nil,ft,tp)
end
function c10485110.spop(e,tp,eg,ep,ev,re,r,rp,c)
	local g=Duel.SelectReleaseGroup(tp,c10485110.cfilter,1,1,nil,Duel.GetLocationCount(tp,LOCATION_MZONE),tp)
