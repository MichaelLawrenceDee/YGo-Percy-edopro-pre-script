...
function c29139104.spcost(e,tp,eg,ep,ev,re,r,rp,chk)
	...
	if chk==0 then return Duel.CheckReleaseGroup(tp,c29139104.cfilter,1,e:GetHandler(),ft,tp) end
	local g=Duel.SelectReleaseGroup(tp,c29139104.cfilter,1,1,e:GetHandler(),ft,tp)
