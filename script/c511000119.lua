...
function c511000119.movecon(e,tp,eg,ep,ev,re,r,rp)
	return Duel.IsExistingMatchingCard(c511000119.mvfilter,tp,LOCATION_ONFIELD,0,1,nil,tp)
end
function c511000119.moveop(e,tp,eg,ep,ev,re,r,rp)
