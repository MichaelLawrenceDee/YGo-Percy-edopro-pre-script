...
function c75417459.cost(e,tp,eg,ep,ev,re,r,rp,chk)
	...
	if chk==0 then return ft>-1 and Duel.CheckReleaseGroup(tp,c75417459.cfilter,1,nil,ft,tp) end
	local g=Duel.SelectReleaseGroup(tp,c75417459.cfilter,1,1,nil,ft,tp)
