...
function c31548814.target(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then
		...
		return g:GetCount()>0 and aux.SelectUnselectGroup(g,e,tp,1,ft,c31548814.rescon,0)
	end
...
function c31548814.activate(e,tp,eg,ep,ev,re,r,rp)
	...
	local sg=aux.SelectUnselectGroup(g,e,tp,1,ft,c31548814.rescon,1,tp,HINTMSG_SPSUMMON)
