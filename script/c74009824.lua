...
function c74009824.filterchk(c,tp,mg,sg,exg,mustg,fc,chkf)
	local res
	...
	if sg:GetCount()<2 then
		...
		res=mg:IsExists(c74009824.filterchk,1,sg,tp,mg,sg,exg,mustg,fc,chkf)
	else
		res=sg:Includes(mustg) and aux.FCheckMixGoal(tp,sg,fc,true,true,chkf,c74009824.ffilter1,c74009824.ffilter2)
	end
	sg:RemoveCard(c)
	mg:Merge(rg)
	return res
...
function c74009824.fuscon(e,g,gc,chkf)
	...
	mg:Merge(mustg)
	return mg:IsExists(c74009824.filterchk,1,nil,tp,mg,Group.CreateGroup(),exg,mustg,c,chkf)
end
function c74009824.filterchk2(c,tp,mg,sg,exg,mustg,fc,chkf)
	return not exg:IsContains(c) and c74009824.filterchk(c,tp,mg,sg,exg,mustg,fc,chkf)
end
function c74009824.filterchk3(c,tp,mg,sg,exg,mustg,fc,chkf)
	return exg:IsContains(c) and c74009824.filterchk(c,tp,mg,sg,exg,mustg,fc,chkf)
end
function c74009824.fusop(e,tp,eg,ep,ev,re,r,rp,gc,chkf)
	...
	while sg:GetCount()<2 do
		...
		local tg2=mg:Filter(c74009824.filterchk3,sg,tp,mg,sg,exg,mustg,c,chkf)
