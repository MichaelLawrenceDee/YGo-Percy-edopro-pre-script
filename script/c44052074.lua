...
function c44052074.tktg(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
	...
	if chk==0 then
		return ft>-1 and Duel.IsExistingTarget(c44052074.desfilter,tp,LOCATION_ONFIELD,0,1,nil)
			and Duel.IsPlayerCanSpecialSummonMonster(tp,44052075,0x7,0x4011,0,0,1,RACE_MACHINE,ATTRIBUTE_EARTH)
	end
	Duel.Hint(HINT_SELECTMSG,tp,HINTMSG_DESTROY)
	local g=Duel.SelectTarget(tp,c44052074.desfilter,tp,LOCATION_ONFIELD,0,1,1,nil)
	Duel.SetOperationInfo(0,CATEGORY_DESTROY,g,1,0,0)
