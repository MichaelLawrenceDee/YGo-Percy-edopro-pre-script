...
function c101003066.initial_effect(c)
	...
	e2:SetDescription(aux.Stringid(91499077,0))
...
function c101003066.eqlimit(e,c)
	return c:GetControler()==e:GetOwnerPlayer() and c:IsType(TYPE_LINK)
end
function c101003066.activate(e,tp,eg,ep,ev,re,r,rp)
