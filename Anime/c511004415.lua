...
function c511004415.target(e,tp,eg,ev,ep,re,r,rp,chk)
	if chk==0 then return eg and eg:IsExists(c511004415.filter1,1,nil,e,tp) 
		and Duel.IsExistingMatchingCard(c511004415.filter2,tp,LOCATION_MZONE+LOCATION_GRAVE,0,1,nil,e,tp) end
	local tg1=eg:FilterSelect(tp,c511004415.filter1,1,1,nil,e,tp)
	local tg2=Duel.SelectMatchingCard(tp,c511004415.filter2,tp,LOCATION_MZONE+LOCATION_GRAVE,0,1,1,nil,e,tp):GetFirst()
