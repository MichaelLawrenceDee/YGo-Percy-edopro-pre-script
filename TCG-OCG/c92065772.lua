...
function c92065772.operation(e,tp,eg,ep,ev,re,r,rp)
	if Duel.GetLocationCount(tp,LOCATION_MZONE,nil,LOCATION_REASON_COUNT)<=0
		and Duel.GetLocationCount(1-tp,LOCATION_MZONE,nil,LOCATION_REASON_COUNT)<=0 then return end
	--disable field
