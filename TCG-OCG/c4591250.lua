...
function c4591250.initial_effect(c)
	c:EnableReviveLimit()
<<<<<<< HEAD
	aux.AddFusionProcMix(true,true,15951532,aux.FilterBoolFunction(Card.IsFusionSetCard,0x4))
=======
	aux.FConditionMix(true,true,15951532,aux.FilterBoolFunction(Card.IsFusionSetCard,0x4))
>>>>>>> origin/master
	--indes
