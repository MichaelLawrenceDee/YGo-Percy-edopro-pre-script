...
function c74823665.spcon(e,c)
	...
	return (Duel.GetLocationCount(tp,LOCATION_MZONE)>0 or Duel.IsPlayerAffectedByEffect(tp,69832741))
		and Duel.IsExistingMatchingCard(c74823665.spfilter,tp,LOCATION_MZONE+LOCATION_GRAVE,0,1,nil)
end
function c74823665.spop(e,tp,eg,ep,ev,re,r,rp,c)
	Duel.Hint(HINT_SELECTMSG,tp,HINTMSG_REMOVE)
	local g=Duel.SelectMatchingCard(tp,c74823665.spfilter,tp,LOCATION_MZONE+LOCATION_GRAVE,0,1,1,nil)
