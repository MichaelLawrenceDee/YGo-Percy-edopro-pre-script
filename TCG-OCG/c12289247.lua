...
function c12289247.cfilter(c)
	if (not c:IsSetCard(0x10f2) and not c:IsSetCard(0x2073) and not c:IsSetCard(0x2017) and not c:IsSetCard(0x1046))
		or not c:IsType(TYPE_MONSTER) or not c:IsAbleToRemoveAsCost() or (c:IsLocation(LOCATION_MZONE) and c:IsFacedown()) then return false end
