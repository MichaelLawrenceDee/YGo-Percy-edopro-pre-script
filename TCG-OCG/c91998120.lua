...
function c91998120.initial_effect(c)
	...
	aux.AddContactFusion(c,c91998120.contactfil,c91998120.contactop)
	--spsummon condition
	...
	e2:SetDescription(aux.Stringid(91998120,0))
	e2:SetCategory(CATEGORY_DESTROY)
	e2:SetType(EFFECT_TYPE_IGNITION)
	e2:SetProperty(EFFECT_FLAG_CARD_TARGET)
	e2:SetRange(LOCATION_MZONE)
	e2:SetCost(c91998120.descost)
	e2:SetTarget(c91998120.destg)
	e2:SetOperation(c91998120.desop)
	c:RegisterEffect(e2)
end
function c91998120.contactfil(tp)
	return Duel.GetMatchingGroup(Card.IsAbleToRemoveAsCost,tp,LOCATION_ONFIELD,0,nil)
end
function c91998120.contactop(g)
