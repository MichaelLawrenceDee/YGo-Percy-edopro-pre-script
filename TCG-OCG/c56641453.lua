...
function c56641453.filter1(c,e,tp)
	...
	return c:IsSetCard(0x1e) and Duel.IsExistingTarget(c56641453.filter2,tp,0x13,0,1,nil,class.listed_names,e,tp)
end
...
function c56641453.target(e,tp,eg,ep,ev,re,r,rp,chk)
	...
	Duel.SetTargetParam(rg:GetFirst():GetOriginalCode())
...
function c56641453.activate(e,tp,eg,ep,ev,re,r,rp)
	...
	local g=Duel.SelectMatchingCard(tp,aux.NecroValleyFilter(c56641453.filter2),tp,0x13,0,1,1,nil,class.listed_names,e,tp)
