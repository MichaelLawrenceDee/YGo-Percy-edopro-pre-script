...
c41735184.listed_names={46986414,38033121,41735184}
...
function c41735184.filter(c)
	return aux.IsCodeListed(c,46986414,38033121) and c:IsType(TYPE_SPELL+TYPE_TRAP)
	and not c:IsCode(41735184) and c:IsAbleToHand()
end
