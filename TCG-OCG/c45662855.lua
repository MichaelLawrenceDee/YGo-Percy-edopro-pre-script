...
function c45662855.costfilter(c,tp)
	if not c:IsSetCard(0x47) or not c:IsType(TYPE_MONSTER) or not c:IsAbleToRemoveAsCost()
		or not Duel.IsExistingTarget(c45662855.tgfilter,tp,LOCATION_GRAVE,0,1,c) then return false end
