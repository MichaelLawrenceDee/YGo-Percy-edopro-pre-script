...
function c79569173.target(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return Duel.GetLocationCount(1-tp,LOCATION_SZONE,nil,LOCATION_REASON_COUNT)>2 end
...
function c79569173.activate(e,tp,eg,ep,ev,re,r,rp)
	if Duel.GetLocationCount(1-tp,LOCATION_SZONE,nil,LOCATION_REASON_COUNT)<3 then return end
	--disable field
