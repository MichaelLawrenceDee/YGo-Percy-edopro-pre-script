...
function c43644025.target(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
	...
	local class=_G["c"..rg:GetFirst():GetOriginalCode()]
	Duel.Release(rg,REASON_COST)
	Duel.Hint(HINT_SELECTMSG,tp,HINTMSG_SPSUMMON)
	local g=Duel.SelectTarget(tp,c43644025.filter2,tp,LOCATION_GRAVE,LOCATION_GRAVE,1,1,nil,class.listed_names,e,tp)
