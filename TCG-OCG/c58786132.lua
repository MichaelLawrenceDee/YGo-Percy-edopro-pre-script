...
function c58786132.cfilter(c)
	if not c:IsLevelAbove(5) or not c:IsAbleToRemoveAsCost() then return false end
...
function c58786132.spcost(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return Duel.IsExistingMatchingCard(c58786132.cfilter,tp,LOCATION_MZONE+LOCATION_GRAVE,0,1,nil) end
	Duel.Hint(HINT_SELECTMSG,tp,HINTMSG_REMOVE)
	local g=Duel.SelectMatchingCard(tp,c58786132.cfilter,tp,LOCATION_MZONE+LOCATION_GRAVE,0,1,1,nil)
